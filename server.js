        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <a href="/" class="absolute left-1/2 transform -translate-x-1/2 flex items-center gap-4 h-full group">
                    <img src="/resources/bal-logo.png" class="h-10 w-auto dark:invert transition-all opacity-90 group-hover:opacity-100">
    ...
    <footer class="border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 transition-colors duration-300 mt-auto">
        <div class="max-w-7xl mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div class="space-y-1 text-center md:text-left">
                <div class="font-serif text-4xl font-black tracking-tighter">BALLAB</div>
            ...
            <!-- Col 2: Quick Links -->
            <div class="flex flex-col gap-3 text-sm font-medium text-gray-600 dark:text-gray-300 text-center md:text-center">
            ...
            <div class="flex flex-col items-center md:items-end justify-between gap-8">
                <img src="/resources/bal-logo.png" class="h-24 w-auto dark:invert transition-all opacity-90 hover:opacity-100">
                <div class="flex items-center gap-3 group">
                     <span class="font-bold tracking-widest text-xs uppercase opacity-50 group-hover:opacity-100 transition-opacity text-right">Corensan<br>Web Solutions</span>
                     <img src="/resources/corensan-logo.png" class="h-10 w-auto dark:invert transition-all">
                </div>
            </div>
        </div>
    </footer>
